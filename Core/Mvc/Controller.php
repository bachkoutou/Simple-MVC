...
class Controller implements IController
{
	...
	public function alwaysAction()
	{
		...
		\Core\Toolbox\Toolbox::getArrayParameter($dispatcher->getParams(),'message',''),
		\Core\Toolbox\Toolbox::getArrayParameter($dispatcher->getParams(),'messageType','success')
		);
	}
     ...
     */
    public function setContainer(\Core\Container\Container $container)
    {
     ...
     */
    public function setView(\Core\Mvc\View $view)
    {
        $this->view = $view;
    }    
}
