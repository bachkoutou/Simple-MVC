...
class Router
{
     ...
     */
    public function route(\Core\Container\Container $container)
    {
        ...
        $controller = \Core\Mvc\ControllerFactory::getController($this->_controller, $controllerConfig);
        ...
        {
            throw new \InvalidArgumentException('you have to specify a valid action for the controller ' . $this->_controller);
        }
    }
